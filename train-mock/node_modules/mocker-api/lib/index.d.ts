...
export default function (app: Express, watchFile: string | string[], conf?: MockerOption): (req: Request<import("express-serve-static-core").ParamsDictionary, any, any, import("express-serve-static-core").Query>, res: Response<any>, next: NextFunction) => void;
